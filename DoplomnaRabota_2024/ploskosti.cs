...
{
    public partial class ploskosti : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    command.Parameters.AddWithValue("@Id", 49);
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            try
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    string selectQuery = "SELECT Id, produkti, cena, kolichestvo FROM produkti WHERE Id = @Id";
                    SqlCommand command = new SqlCommand(selectQuery, connection);
                    command.Parameters.AddWithValue("@Id", 51);
                    SqlDataReader reader = command.ExecuteReader();
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            try
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    string selectQuery = "SELECT Id, produkti, cena, kolichestvo FROM produkti WHERE Id = @Id";
                    SqlCommand command = new SqlCommand(selectQuery, connection);
                    command.Parameters.AddWithValue("@Id", 52);
                    SqlDataReader reader = command.ExecuteReader();
        ...
        private void button12_Click(object sender, EventArgs e)
        {
            try
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    string selectQuery = "SELECT Id, produkti, cena, kolichestvo FROM produkti WHERE Id = @Id";
                    SqlCommand command = new SqlCommand(selectQuery, connection);
                    command.Parameters.AddWithValue("@Id", 53);
                    SqlDataReader reader = command.ExecuteReader();
        ...
        private void button11_Click(object sender, EventArgs e)
        {
            try
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    string selectQuery = "SELECT Id, produkti, cena, kolichestvo FROM produkti WHERE Id = @Id";
                    SqlCommand command = new SqlCommand(selectQuery, connection);
                    command.Parameters.AddWithValue("@Id", 54);
                    SqlDataReader reader = command.ExecuteReader();
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            try
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    string selectQuery = "SELECT Id, produkti, cena, kolichestvo FROM produkti WHERE Id = @Id";
                    SqlCommand command = new SqlCommand(selectQuery, connection);
                    command.Parameters.AddWithValue("@Id", 57);
                    SqlDataReader reader = command.ExecuteReader();
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            try
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    string selectQuery = "SELECT Id, produkti, cena, kolichestvo FROM produkti WHERE Id = @Id";
                    SqlCommand command = new SqlCommand(selectQuery, connection);
                    command.Parameters.AddWithValue("@Id", 58);
                    SqlDataReader reader = command.ExecuteReader();
