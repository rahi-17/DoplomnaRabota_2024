...
Integrated Security=True;Connect Timeout=30;");
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            try
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    string selectQuery = "SELECT Id, produkti, cena, kolichestvo FROM produkti WHERE Id = @Id";
                    SqlCommand command = new SqlCommand(selectQuery, connection);
                    command.Parameters.AddWithValue("@Id", 43);
                    SqlDataReader reader = command.ExecuteReader();
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            try
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    string selectQuery = "SELECT Id, produkti, cena, kolichestvo FROM produkti WHERE Id = @Id";
                    SqlCommand command = new SqlCommand(selectQuery, connection);
                    command.Parameters.AddWithValue("@Id", 44);
                    SqlDataReader reader = command.ExecuteReader();
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            try
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    string selectQuery = "SELECT Id, produkti, cena, kolichestvo FROM produkti WHERE Id = @Id";
                    SqlCommand command = new SqlCommand(selectQuery, connection);
                    command.Parameters.AddWithValue("@Id", 45);
                    SqlDataReader reader = command.ExecuteReader();
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            try
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    string selectQuery = "SELECT Id, produkti, cena, kolichestvo FROM produkti WHERE Id = @Id";
                    SqlCommand command = new SqlCommand(selectQuery, connection);
                    command.Parameters.AddWithValue("@Id", 46);
                    SqlDataReader reader = command.ExecuteReader();
        ...
        private void button12_Click(object sender, EventArgs e)
        {
            try
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    string selectQuery = "SELECT Id, produkti, cena, kolichestvo FROM produkti WHERE Id = @Id";
                    SqlCommand command = new SqlCommand(selectQuery, connection);
                    command.Parameters.AddWithValue("@Id", 47);
                    SqlDataReader reader = command.ExecuteReader();
        ...
        private void button11_Click(object sender, EventArgs e)
        {
            try
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    string selectQuery = "SELECT Id, produkti, cena, kolichestvo FROM produkti WHERE Id = @Id";
                    SqlCommand command = new SqlCommand(selectQuery, connection);
                    command.Parameters.AddWithValue("@Id", 48);
                    SqlDataReader reader = command.ExecuteReader();
        ...
        private void durvenmaterial_Load(object sender, EventArgs e)
        {
